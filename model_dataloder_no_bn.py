...
train_dataset = datasets.ImageFolder(root='chest_xray/train', transform = data_transform)
val_dataset = datasets.ImageFolder(root='chest_xray/train/',transform = data_transform)
...
torch.save(model,'Model/chest_xray_pytorch_no_bn.model')